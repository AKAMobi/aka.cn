...
<tr>
	...
	<? echo ((floatval($row['Incoming'])!=0)?$row['Incoming']:"") ; ?>
	</td >
	<td align="right" width="55"><font color="#ff0000">
	<? echo ((floatval($row['Outcoming'])!=0)?$row['Outcoming']:"") ; ?>
	</font>
	</td>
