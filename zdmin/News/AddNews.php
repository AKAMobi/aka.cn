...
<tr><td>新闻类型：原有新闻类型<input type="radio" name="ExistClass" value="yes" checked><select name="OldClass">
	...
	?>
	</select><br>增加新闻类型<input type="radio" name="ExistClass" value="no"><input type="text" name="NewClass" size=20></td></tr>
<tr><td>是否为重要新闻：<input type="radio" name="Important" value="N" checked>否<input type="radio" name="Important" value="Y">是</td></tr>
<tr><td>是否需要在个人VPN客户端显示：<input type="radio" name="ShowOnVPNClient" value="N" checked>否<input type="radio" name="ShowOnVPNClient" value="Y">是</td></tr>
<tr><td>选择图片上传：<input type=file name=file size=20></td></tr>
<tr><td>新闻题目<input type="text" name="Title" size=70></td></tr>
<tr><td>新闻内容<textarea name="Body" wrap="VIRTUAL" cols="70" rows="20"></textarea></td></tr>
